...
export default function Skills() {
    ...
    return (
        <div>
            <span className='flex items-center gap-2 text-xs border border-[#565656] rounded-full w-fit px-4 py-2 mb-5 mt-24' id='skills' data-aos="fade-up" data-aos-duration="1500"><LiaShapesSolid />SKILLS</span>
            <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-8 mb-16' data-aos="fade-up" data-aos-duration="1500">My <span className='text-primary'>Skills</span></h1>
