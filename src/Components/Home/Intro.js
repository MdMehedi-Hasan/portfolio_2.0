...
export default function Intro() {
    return (
        <div className="mt-20">
            ...
            <h1 className='text-2xl sm:text-4xl md:text-5xl lg:text-6xl mt-8 tracking-wider leading-snug'>Say Hi from <span className='text-primary'>Mehedi</span>,</h1>
            <h1 className='text-2xl sm:text-4xl md:text-5xl lg:text-6xl tracking-wider leading-snug'>Professional Front-end Developer</h1>
            ...
            <div className='flex items-center gap-20'>
                <div data-aos="fade-right" data-aos-duration="1500">
                    <h5 className='text-3xl sm:text-4xl md:text-6xl text-primary mb-5'>03+</h5>
                    <p className='text-secondary'>YEARS OF <br /> EXPERIENCE</p>
                </div>
                <div data-aos="fade-left" data-aos-duration="1500">
                    <h5 className='text-3xl sm:text-4xl md:text-6xl text-primary mb-5'>25+</h5>
