...
export default function About() {
    return (
        <div className='mt-36'>
            ...
            <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-2xl mt-12' data-aos="fade-up" data-aos-duration="1500">Proper execution can add more value <span className='text-primary'>to the design</span>.</h1>
