...
export default function SideProfile() {
    ...
    return (
        <div className='border border-neutral-500 rounded-xl p-3 sideProfile'>
            <span className='flex gap-1 text-2xl font-semibold mt-2 mb-5'>Mehedi <sup className='border rounded-full w-5 h-5 text-xs flex items-center justify-center font-normal'>M</sup></span>
            ...
            <h1 className='px-3 text-lg font-semibold text-center mt-5'>Md Mehedi Hasan <br /> Front-End Developer</h1>
            ...
            <div className='flex justify-center mt-5'>
                <button className='bg-green-600 rounded-full w-2/3 py-2'>Hire Me!</button>
            </div>
        </div>
    )
}
